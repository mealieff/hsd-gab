...
python3 sing_label_method.py \
  ...
  --output sing_label_data2_1/multiclass_ADASYN_single_label.npy
...
python3 sing_label_method.py \
  ...
  --output sing_label_data2_1/multiclass_CondensedNearestNeighbour_single_label.npy
...
python3 sing_label_method.py \
  ...
  --output sing_label_data2_1/multiclass_RandomOverSampler_single_label.npy
...
python3 sing_label_method.py \
  ...
  --output sing_label_data2_1/multiclass_RandomUnderSampler_single_label.npy

python3 sing_label_method.py \
  --train_embeddings resampled_data/multiclass_SMOTE_embeddings.npy \
  --train_labels resampled_data/multiclass_SMOTE_labels.npy \
  --output sing_label_data2_1/multiclass_SMOTE_single_label.npy
