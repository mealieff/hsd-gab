...
binary_files = [
    ("binary_ADASYN", "resampled_data_binary31/binary_ADASYN_embeddings.npy", "resampled_data_binary31/binary_ADASYN_labels.npy"),
    ("binary_CondensedNearestNeighbour", "resampled_data_binary31/binary_CondensedNearestNeighbour_embeddings.npy", "resampled_data_binary31/binary_CondensedNearestNeighbour_labels.npy"),
    ("binary_RandomOverSampler", "resampled_data_binary31/binary_RandomOverSampler_embeddings.npy", "resampled_data_binary31/binary_RandomOverSampler_labels.npy"),
    ("binary_RandomUnderSampler", "resampled_data_binary31/binary_RandomUnderSampler_embeddings.npy", "resampled_data_binary31/binary_RandomUnderSampler_labels.npy"),
    ("binary_SMOTE", "resampled_data_binary31/binary_SMOTE_embeddings.npy", "resampled_data_binary31/binary_SMOTE_labels.npy"),
    ("binary_SMOTEENN", "resampled_data_binary31/binary_SMOTEENN_embeddings.npy", "resampled_data_binary31/binary_SMOTEENN_labels.npy"),
    ("binary_TomekLinks", "resampled_data_binary31/binary_TomekLinks_embeddings.npy", "resampled_data_binary31/binary_TomekLinks_labels.npy")
]
